...
PREPARE update_tt10872600_set_seen_true_rating_11 AS
    UPDATE movies SET seen = true, rating = 11 WHERE imdb_id = 'tt10872600-test';
SELECT throws_ilike(
    'update_tt10872600_set_seen_true_rating_11',
